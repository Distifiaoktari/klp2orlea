...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 23, 2021 at 02:00 PM
...
CREATE TABLE `barberman` (
  ...
  `alamat_barberman` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nohp_barberman` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
